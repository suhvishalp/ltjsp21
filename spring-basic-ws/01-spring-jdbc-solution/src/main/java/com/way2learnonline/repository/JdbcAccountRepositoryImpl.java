...
public class JdbcAccountRepositoryImpl implements AccountRepository {
	...
	public void save(Account account)  {
		...
		jdbcTemplate.update(query,account.getName(),account.isActive(),account.getAddress().getCity(),
				account.getAddress().getCountry(),account.getBalance(),
	...
	public void update(Account account) {
		...
		jdbcTemplate.update(query,account.getName(),account.isActive(),
				account.getAddress().getCity(),account.getAddress().getCountry(),
				account.getBalance(),
